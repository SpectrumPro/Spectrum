...
## Server: Called when fixtures are added
func on_fixtures_added(group_items: Array) -> void: 
	_add_group_items(group_items)

## Server: Called when fixtures are removed
func on_fixtrues_removed(fixtures: Array[Fixture]) -> void: _remove_fixtures(fixtures)
