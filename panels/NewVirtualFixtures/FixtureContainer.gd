...
func add_fixture(fixture: Fixture, set_vf_selected: bool = true, at_position: Vector2 = Vector2.ZERO, no_group_add: bool = false) -> void:
	...
	var new_vf: NewVirtualFixture = load("res://panels/NewVirtualFixtures/VirtualFixture/VirtualFixture.tscn").instantiate()
...
func _on_fixture_group_fixtures_added(group_items: Array) -> void:
	for group_item: FixtureGroupItem in group_items:
		add_fixture(group_item.fixture, false, _get_v2_position(group_item.fixture), true)
...
func _get_v2_position(fixture: Fixture) -> Vector2:
	var pos3: Vector3 = fixture_group.get_group_item(fixture).position
...
func _get_v3_position(vf: NewVirtualFixture) -> Vector3:
	...
	return _get_v3_position_from_v2(pos2, fixture_group.get_group_item(vf.fixture).position)
