...
func set_edit_mode(p_edit_mode: bool) -> void:
	...
	$TitleBar/HBoxContainer/EditControls/HBoxContainer/EditMode.button_pressed = _edit_mode
	$GridAlignSize.hide()
...
## Sets the dissabled state on the edit mode toggle button
func set_edit_mode_disabled(state: bool) -> void:
	$TitleBar/HBoxContainer/EditControls/HBoxContainer/EditMode.disabled = state
...
## Called when the edit mode button is pressed
