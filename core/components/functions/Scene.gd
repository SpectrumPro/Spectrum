...
func _component_ready() -> void:
	...
	register_control_method("Fade In Speed", set_fade_in_speed, get_fade_in_speed, fade_in_speed_changed, [TYPE_FLOAT])
	register_control_method("Fade Out Speed", set_fade_out_speed, get_fade_out_speed, fade_out_speed_changed, [TYPE_FLOAT])
